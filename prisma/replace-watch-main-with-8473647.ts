...
async function main() {
  console.log('🔄 Замена заглавной фотки на 8473647.webp...\n');
  ...
  if (fs.existsSync(targetImagePath)) {
    ...
    const backupPath = path.join(folderPath, `_backup_old_00_main_${Date.now()}.webp`);
  ...
  // Проверяем порядок файлов после замены
